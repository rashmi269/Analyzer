...
def push_data(value,flag,testname):
    ...
    :param flag: flag of the test
    :param testname: name of the test
    :return: String message = Push complete

    contains the remote database connections variables and authentication parameters

    this module also contains specific instructions on how to install and configure myslpython on raspberripy and how to connect to remote database.
